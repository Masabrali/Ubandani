        ...
        <Container style={ [Styles.wrapper] }>
            ...
            <View style={ [Styles.flexRow, Styles.flexJustityCenter, Styles.flexAlignCenter, Styles.borderBottom, Styles.padding, Styles.doublePaddingBottom, Styles.backgroundUbandaniLight] }>
                ...
                <View style={ [Styles.flex, Styles.paddingLeft, Styles.paddingRight] }>
                    <Text numberOfLines={2} style={ [Styles.textLarge] }>{ props.item.title }</Text>
            ...
            <Content padder style={ [Styles.backgroundKimyaKimyaLight, Styles.flex] } contentContainerStyle={ [Styles.doublePadding] }>
                { !!props.item.starring && <View style={ [Styles.flexRow, Styles.flexJustifyStart, Styles.flexAlignStart, Styles.halfMarginBottom] }>
                        <Text style={ [Styles.textLabel] }>Starring:</Text>
                        <Text style={ [Styles.halfMarginLeft] }>{ props.item.starring }</Text>
                    </View>
                }
                { !isEmpty(props.item.cast) && <View style={ [Styles.flexRow, Styles.flexJustifyStart, Styles.flexAlignStart] }>
                        <Text style={ [Styles.textLabel] }>Cast:</Text>
                        <Text style={ [Styles.halfMarginLeft, Styles.marginRight] }>{ props.item.cast.join(', ') }</Text>
                   </View>
                }
                <Text style={ [Styles.marginTop, Styles.textLabel, Styles.textMedium, { lineHeight: 28 }] }>{ props.item.excerpt }</Text>
            </Content>
        </Container>
    );
}
